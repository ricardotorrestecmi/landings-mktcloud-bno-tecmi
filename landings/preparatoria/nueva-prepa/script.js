...
/* Carrusel de ubicaciones: mismo patron que el de rutas de la plantilla, pero este
   modulo si lleva flechas en escritorio (asi esta en el Figma: la tercera tarjeta
   queda cortada a proposito y se navega con ellas). */
