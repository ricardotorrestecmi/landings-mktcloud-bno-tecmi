...
- Static preview adapted from the validated Finanzas structure.
- SFMC integration block pending.

## Source Details

- HubSpot URL: https://universidad.tecmilenio.mx/maestria-administracion-mercadotecnia
- HubSpot page ID: `211665481093`
...
- Before SFMC handoff, replace the static form with the real CloudPages form/AMPscript block.
